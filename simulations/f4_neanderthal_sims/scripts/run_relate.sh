...
do
  ...
  Relate --mode All --haps ${file}_masked_chr${chr}.haps.gz --sample ${file}_masked_chr${chr}.sample.gz --map ../../recomb_rates/genetic_map_combined_b37_chr${chr}.txt.gz -m 1.25e-8 -N 20000 -o relate_${file}_chr${chr} --coal ${file}.coal --consistency 
