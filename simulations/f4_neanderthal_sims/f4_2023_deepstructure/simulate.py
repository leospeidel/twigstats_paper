...
def migration_example(chr, migrate, file):
    ...
    demography.add_symmetric_migration_rate_change(time = 3000, rate = migrate, populations = ["P3", "P4"])
    ...
    demography.add_symmetric_migration_rate_change(time = 25000, rate = migrate, populations = ["P123", "P4"])
    demography.add_population_split(time=40000, derived=["P123", "P4"], ancestral="P1234")
