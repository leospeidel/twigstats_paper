...
poplabels <- "SGDP_aDNA_fine.poplabels"
...
if(j == 1){
  ...
  if(mut){
    ...
    save(f2_blocks, file = paste0("f2_Relate_fine_transv_dated_chr",chr,".RData"))
  }else{
    cat("use trees\n")
    ...
    save(f2_blocks, file = paste0("f2_Relate_fine_transv_chr",chr,".RData"))
  }
  ...
  if(mut){
    ...
    save(f2_blocks, file = paste0("f2_Relate_fine_transv_dated_",cut,"_chr",chr,".RData"))
  }else{
    cat("use trees\n")
    ...
    save(f2_blocks, file = paste0("f2_Relate_fine_transv_",cut,"_chr",chr,".RData"))
  }
